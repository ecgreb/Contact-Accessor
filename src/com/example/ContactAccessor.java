...
public abstract class ContactAccessor {
    ...
    public static ContactAccessor getInstance() {
        if (sInstance == null) {
            ...
            if (sdkVersion < Build.VERSION_CODES.ECLAIR) {
                className = "com.example.ContactAccessorSdk3_4";
            } else {
                className = "com.example.ContactAccessorSdk5";
            }
    ...
    public abstract List<Contact> queryContacts();

    public abstract List<String> queryPhoneNumbers(String id);

    public abstract List<String> queryEmailAddresses(String id);
